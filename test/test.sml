...
struct
  ...
  fun run () =
    let
      ...
      (* FIPS 180-4 SHA-512 vectors. *)
      val () = section "SHA-512 (FIPS 180-4 vectors)"
      val () = checkString "empty"
      ...
      val () = checkString "million a's"
                 ("e718483d0ce769644e2e42c7bc15b4638e1f98b13b2044285632a803afa973eb\
                  ...
                  Sha512.hexDigest (String.implode (List.tabulate (1000000, fn _ => #"a"))))
      val () = checkInt "digest length is 64" (64, String.size (Sha512.digest "abc"))
